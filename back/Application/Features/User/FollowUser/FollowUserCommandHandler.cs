...
{
    public class FollowUserCommandHandler(UserManager<UserEntity> userManager, ICurrentUser currentUser, IAppDbContext appDbContext) : IRequestHandler<FollowUserCommand, Unit>
    {
