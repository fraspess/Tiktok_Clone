...
{
    public class GetCurrentUserQueryHandler(UserManager<UserEntity> userManager, UserMapper mapper, IStorageService storageService, ICurrentUser currentUser, ICacheService cache)
