...
public class GetFollowingFYPCommandHandler(IAppDbContext context, ICurrentUser currentUser, VideoMapper videoMapper) : IRequestHandler<GetFollowingFYPCommand, PagedResult<VideoDto>>
{
