...
internal class AdminPanelGetVideosCommandHandler(IAppDbContext appDbContext, VideoMapper mapper, ICurrentUser user) : IRequestHandler<AdminPanelGetVideosCommand, PagedResult<SimpleVideoDto>>
{
